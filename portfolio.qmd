...
::: columns
::: {.column width="55%"}
Consultancy for a group participating in a closed Kaggle competition. The main objective was to optimize out-of-sample prediction. At the end, the group gained confidence to employ their own strategies and further enhance the models, resulting in improved performance in the competition.
:::
...
::: {.column width="40%"}
[![](images/dataconsulting.jfif){width="80%"}](https://www.kaggle.com/code/gustavocxavier/train-xgb-nnet-stack/notebook)
:::
...
3.  Implementing a stacked models approach to combine the best-performing models.
 ...
 [Check out a Kaggle notebook example](https://github.com/gustavocxavier/EIGtextRegression)
:::
